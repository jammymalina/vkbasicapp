...
void mem_copy(const void* src, void* dest, size_t length) { SDL_memcpy(dest, src, length); }

void* mem_move(const void* src, void* dest, size_t length) { return SDL_memmove(dest, src, length); }
